...
allplayers.app.prototype.init=function(){document.proxy=this};allplayers=allplayers||{app:{}};allplayers.app.client=function(c){allplayers.app.call(this,c,{getContainer:function(){return jQuery()}})};allplayers.app.client.prototype=new allplayers.app;allplayers.app.client.prototype.constructor=allplayers.app.client;
allplayers.app.client.prototype.init=function(){allplayers.app.prototype.init.call(this);this.container=this.options.getContainer();this.height=0;this.heightTimer=null;this.queue={};this.reg=null;var c=this;this.proxy=new Porthole.WindowProxy(this.options.proxy);var b=null;jQuery(document).bind("DOMSubtreeModified",function(){b&&clearTimeout(b);b=setTimeout(function(){c.resize()},500)});this.proxy.addEventListener(function(a){var b=a.data.hasOwnProperty("event")?a.data.event:!1;if(b)switch(b.name){case "chromeMsgResp":if(b.data.hasOwnProperty("guid")&&
c.queue.hasOwnProperty(b.data.guid))c.queue[b.data.guid](b.data.response);break;case "chromePluginReady":window.postMessage(b,"*");break;case "getRegistration":c.reg=a.data.hasOwnProperty("reg")?a.data.reg:!1}});this.resize();this.proxy.post({event:{name:"clientReady"}})};
allplayers.app.client.prototype.sendMessage=function(c,b){var a=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)};c.guid=a()+a()+a();this.proxy.post({event:{name:"chromeMsg",data:c}});this.queue[c.guid]=b};
