(function(){var c=!1,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!c&&this.init&&this.init.apply(this,arguments)}var e=this.prototype;c=!0;var f=new this;c=!1;for(var g in a)f[g]="function"==typeof a[g]&&"function"==typeof e[g]&&b.test(a[g])?function(a,b){return function(){var d=this._super;this._super=e[a];var c=b.apply(this,arguments);this._super=d;return c}}(g,a[g]):a[g];d.prototype=f;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
a.sourceOrigin,d)):b.error("Target origin "+d.origin+" does not match desired target of "+a.targetOrigin):b.error("Could not find window proxy object on the target window"))},findWindowProxyObjectInWindow:function(a,b){var c;a.RuntimeObject&&(a=a.RuntimeObject());if(a)for(c in a)if(a.hasOwnProperty(c))try{if(null!==a[c]&&"object"===typeof a[c]&&a[c]instanceof a.Porthole.WindowProxy&&a[c].getTargetWindowName()===b)return a[c]}catch(f){}return null},start:function(){c.addEventListener?c.addEventListener("resize",
b.WindowProxyDispatcher.forwardMessageEvent,!1):document.body.attachEvent?c.attachEvent("onresize",b.WindowProxyDispatcher.forwardMessageEvent):b.error("Cannot attach resize event")}};"undefined"!==typeof c.exports?c.exports.Porthole=b:c.Porthole=b})(this);var allplayers=allplayers||{};allplayers.app=function(c,b){if(b){b.proxy="https://www.allplayers.com";b.proxy+="/sites/all/libraries/porthole/src/proxy.html";c=c||{};for(var a in b)c.hasOwnProperty(a)||(c[a]=b[a]);this.options=c;this.init()}};
allplayers.app.prototype.init=function(){document.proxy=this};allplayers=allplayers||{app:{}};jQuery.fn.allplayers_server||(jQuery.fn.allplayers_server=function(c){return jQuery(this).each(function(){new allplayers.app.server(c,jQuery(this))})});allplayers.app.server=function(c,b){this.context=b;allplayers.app.call(this,c,{spinner:"",loading:"Loading",base:"https://platform.allplayers.com",type:"registration",group:"api",query:{},reg:{},src:"",style:"",complete:function(){}})};
allplayers.app.server.prototype=new allplayers.app;allplayers.app.server.prototype.constructor=allplayers.app.server;allplayers.app.server.getParam=function(c){c=c.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");c=RegExp("[\\?&]"+c+"=([^&#]*)").exec(window.location.search);return null==c?"":decodeURIComponent(c[1].replace(/\+/g," "))};
allplayers.app.server.prototype.init=function(){allplayers.app.prototype.init.call(this);this.options.spinner||(this.options.spinner=this.options.base,this.options.spinner+="/sites/all/themes/basic_foundation",this.options.spinner+="/images/loader.gif");this.pluginReady=!1;var c=jQuery(document.createElement("div")).css({background:"url("+this.options.spinner+") no-repeat 10px 13px",padding:"10px 10px 10px 60px",width:"100%"});c.append(this.options.loading);var b=this.context.attr("id")+"_iframe",
a="";if(a=allplayers.app.server.getParam("apq"))a=this.options.base+"/"+a;else if(this.options.src)a=this.options.src;else{a=this.options.base+"/g/"+this.options.group;switch(this.options.type){case "registration":a+="/register";break;case "forms":a+="/forms"}this.options.query.etyp=this.options.type}a+=-1===a.search(/\?/)?"?":"&";if(!function(a){for(var b in a)return!1;return!0}(this.options.query))for(var d in this.options.query)a+=d+"="+encodeURIComponent(this.options.query[d]),a+="&";var a=a+
("#"+b),e=jQuery(document.createElement("iframe")).attr({id:b,name:b,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",src:a}).css({border:"none",overflowY:"hidden"});this.context.append(c);this.context.append(e);this.proxy=new Porthole.WindowProxy(this.options.proxy,e.attr("id"));var f=this;"undefined"!==typeof window.postMessage&&window.addEventListener("message",function(a){switch(a.data.name){case "chromeMsgResp":f.proxy.post({event:a.data});break;case "chromePluginReady":f.pluginReady=
!0}});this.proxy.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1)switch(a.name){case "chromeMsg":"undefined"!==typeof window.postMessage&&window.postMessage(a,"*");break;case "init":c.remove();e.height(a.height).attr("height",a.height+"px");break;case "addProduct":$("<input>").attr({type:"hidden",name:"add-product[]",value:JSON.stringify(a.params)}).appendTo("form");$("#edit-next").val("Continue");break;case "clientReady":f.pluginReady&&f.proxy.post({event:{name:"chromePluginReady"}}),
f.proxy.post({event:{name:"getRegistration"},reg:f.options.reg})}})};
