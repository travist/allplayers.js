(function(){var b=!1,c=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!b&&this.init&&this.init.apply(this,arguments)}var h=this.prototype;b=!0;var e=new this;b=!1;for(var g in a)e[g]="function"==typeof a[g]&&"function"==typeof h[g]&&c.test(a[g])?function(a,d){return function(){var c=this._super;this._super=h[a];var b=d.apply(this,arguments);this._super=c;return b}}(g,a[g]):a[g];d.prototype=e;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
a)};b.addEventListener("message",this.eventListenerCallback,!1)}return this._super(a)},removeEventListener:function(a){this._super(a);0===this.eventListeners.length&&(b.removeEventListener("message",this.eventListenerCallback),this.eventListenerCallback=null)},eventListener:function(a,b){var h=c.WindowProxy.unserialize(b.data);h&&(""==a.targetWindowName||h.sourceWindowName==a.targetWindowName)&&a.dispatchEvent(new c.MessageEvent(h.data,b.origin,a))}});"function"!==typeof b.postMessage?(c.trace("Using legacy browser support"),
...
(function(b){function c(a,c,b,d,j,g){a=String(a);for(var e=0,f=0,h=a.length,m="",k=0;f<h;){for(var l=a.charCodeAt(f),l=256>l?b[l]:-1,e=(e<<j)+l,k=k+j;k>=g;)k-=g,l=e>>k,m+=d.charAt(l),e^=l<<k;++f}!c&&0<k&&(m+=d.charAt(e<<g-k));return m}for(var a="",d=[256],h=[256],e=0,g={encode:function(a){return a.replace(/[\u0080-\u07ff]/g,function(a){a=a.charCodeAt(0);return String.fromCharCode(192|a>>6,128|a&63)}).replace(/[\u0800-\uffff]/g,function(a){a=a.charCodeAt(0);return String.fromCharCode(224|a>>12,128|
a>>6&63,128|a&63)})},decode:function(a){return a.replace(/[\u00e0-\u00ef][\u0080-\u00bf][\u0080-\u00bf]/g,function(a){a=(a.charCodeAt(0)&15)<<12|(a.charCodeAt(1)&63)<<6|a.charCodeAt(2)&63;return String.fromCharCode(a)}).replace(/[\u00c0-\u00df][\u0080-\u00bf]/g,function(a){a=(a.charCodeAt(0)&31)<<6|a.charCodeAt(1)&63;return String.fromCharCode(a)})}};256>e;){var f=String.fromCharCode(e),a=a+f;h[e]=e;d[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(f);++e}var j=b.base64=
function(a,c,b){return c?j[a](c,b):a?null:this};j.btoa=j.encode=function(a,b){a=!1===j.raw||j.utf8encode||b?g.encode(a):a;a=c(a,!1,h,"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",8,6);return a+"====".slice(a.length%4||4)};j.atob=j.decode=function(b,e){b=b.replace(/[^A-Za-z0-9\+\/\=]/g,"");b=String(b).split("=");var f=b.length;do--f,b[f]=c(b[f],!0,d,a,6,8);while(0<f);b=b.join("");return!1===j.raw||j.utf8decode||e?g.decode(b):b}})(jQuery);allplayers=allplayers||{embed:{}};
...
"/register";break;case "forms":a+="/forms"}this.options.query.etyp=this.options.type}a+=-1===a.search(/\?/)?"?":"&";a:{for(var h in this.options.query){d=!1;break a}d=!0}if(!d)for(var e in this.options.query)a+=e+"="+encodeURIComponent(this.options.query[e]),a+="&";var a=a+("esrc="+jQuery.base64("btoa",window.location.href,!0)),a=a+("#"+c),g=jQuery(document.createElement("iframe")).attr({id:c,name:c,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",src:a}).css({border:"none",overflowY:"hidden"});
this.context.append(b);this.context.append(g);this.proxy=new Porthole.WindowProxy(this.options.proxy,g.attr("id"));var f=this;"undefined"!==typeof window.postMessage&&window.addEventListener("message",function(a){switch(a.data.name){case "chromeMsgResp":f.proxy.post({event:a.data});break;case "chromePluginReady":f.pluginReady=!0}});this.proxy.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1)switch(a.name){case "chromeMsg":"undefined"!==typeof window.postMessage&&window.postMessage(a,
"*");break;case "init":b.remove();f.options.style&&f.proxy.post({event:{name:"addStyle",data:f.options.style}});g.height(a.height).attr("height",a.height+"px");break;case "complete":f.options.complete.call(f,a);break;case "serverReady":f.pluginReady&&f.proxy.post({event:{name:"chromePluginReady"}})}})};
