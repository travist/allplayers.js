(function(){var b=!1,c=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!b&&this.init&&this.init.apply(this,arguments)}var g=this.prototype;b=!0;var f=new this;b=!1;for(var e in a)f[e]="function"==typeof a[e]&&"function"==typeof g[e]&&c.test(a[e])?function(a,d){return function(){var c=this._super;this._super=g[a];var b=d.apply(this,arguments);this._super=c;return b}}(e,a[e]):a[e];d.prototype=f;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
(function(b){function c(a,c,b,d,h,f){a=String(a);for(var e=0,g=0,j=a.length,m="",k=0;g<j;){for(var l=a.charCodeAt(g),l=256>l?b[l]:-1,e=(e<<h)+l,k=k+h;k>=f;)k-=f,l=e>>k,m+=d.charAt(l),e^=l<<k;++g}!c&&0<k&&(m+=d.charAt(e<<f-k));return m}for(var a="",d=[256],g=[256],f=0,e={encode:function(a){return a.replace(/[\u0080-\u07ff]/g,function(a){a=a.charCodeAt(0);return String.fromCharCode(192|a>>6,128|a&63)}).replace(/[\u0800-\uffff]/g,function(a){a=a.charCodeAt(0);return String.fromCharCode(224|a>>12,128|
a>>6&63,128|a&63)})},decode:function(a){return a.replace(/[\u00e0-\u00ef][\u0080-\u00bf][\u0080-\u00bf]/g,function(a){a=(a.charCodeAt(0)&15)<<12|(a.charCodeAt(1)&63)<<6|a.charCodeAt(2)&63;return String.fromCharCode(a)}).replace(/[\u00c0-\u00df][\u0080-\u00bf]/g,function(a){a=(a.charCodeAt(0)&31)<<6|a.charCodeAt(1)&63;return String.fromCharCode(a)})}};256>f;){var j=String.fromCharCode(f),a=a+j;g[f]=f;d[f]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(j);++f}var h=b.base64=
function(a,c,b){return c?h[a](c,b):a?null:this};h.btoa=h.encode=function(a,b){a=!1===h.raw||h.utf8encode||b?e.encode(a):a;a=c(a,!1,g,"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",8,6);return a+"====".slice(a.length%4||4)};h.atob=h.decode=function(b,f){b=b.replace(/[^A-Za-z0-9\+\/\=]/g,"");b=String(b).split("=");var g=b.length;do--g,b[g]=c(b[g],!0,d,a,6,8);while(0<g);b=b.join("");return!1===h.raw||h.utf8decode||f?e.decode(b):b}})(jQuery);allplayers=allplayers||{embed:{}};
...
"/register";break;case "forms":a+="/forms"}this.options.query.embedtype=this.options.type;a:{for(var g in this.options.query){d=!1;break a}d=!0}if(!d){var a=a+"?",f;for(f in this.options.query)a+=f+"="+encodeURIComponent(this.options.query[f]),a+="&";a=a.replace(/\&$/,"")}}var a=a+(-1===a.search(/\?/)?"?":"&"),a=a+("embedsource="+$.base64("btoa",window.location.href,!0)),a=a+("#"+c),e=jQuery(document.createElement("iframe")).attr({id:c,name:c,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",
src:a}).css({border:"none",overflowY:"hidden"});this.context.append(b);this.context.append(e);this.proxy=new Porthole.WindowProxy(this.options.proxy,e.attr("id"));var j=this;"undefined"!==typeof window.postMessage&&window.addEventListener("message",function(a){switch(a.data.name){case "chromeMsgResp":j.proxy.post({event:a.data});break;case "chromePluginReady":j.pluginReady=!0}});this.proxy.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1)switch(a.name){case "chromeMsg":"undefined"!==
typeof window.postMessage&&window.postMessage(a,"*");break;case "init":b.remove();e.height(a.height).attr("height",a.height+"px");break;case "complete":j.options.complete.call(j,a);break;case "serverReady":j.pluginReady&&j.proxy.post({event:{name:"chromePluginReady"}})}})};
