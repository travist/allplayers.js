...
d+"="+encodeURIComponent(this.options.query[d])}}var a=a+("#"+b),e=jQuery(document.createElement("iframe")).attr({id:b,name:b,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",src:a}).css({border:"none",overflowY:"hidden"});this.context.append(c);this.context.append(e);var g=new Porthole.WindowProxy(this.options.proxy,e.attr("id")),f=this;g.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1){switch(a.name){case "init":c.remove();e.height(a.height).attr("height",
a.height+"px");break;case "complete":f.options.complete.call(f,a)}var b={};b[a.name]=!0;g.post(b)}})};
