(function(){var c=!1,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!c&&this.init&&this.init.apply(this,arguments)}var f=this.prototype;c=!0;var g=new this;c=!1;for(var e in a)g[e]="function"==typeof a[e]&&"function"==typeof f[e]&&b.test(a[e])?function(a,b){return function(){var d=this._super;this._super=f[a];var c=b.apply(this,arguments);this._super=d;return c}}(e,a[e]):a[e];d.prototype=g;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
"/register";break;case "forms":a+="/forms"}this.options.query.embedtype=this.options.type;if(!jQuery.isEmptyObject(this.options.query)){var a=a+"?",f;for(f in this.options.query)a+=f+"="+encodeURIComponent(this.options.query[f]),a+="&";a=a.replace(/\&$/,"")}}var a=a+(-1===a.search(/\?/)?"?":"&"),a=a+("embedsource="+encodeURIComponent(window.location.href)),a=a+("#"+b),g=jQuery(document.createElement("iframe")).attr({id:b,name:b,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",src:a}).css({border:"none",
overflowY:"hidden"});this.context.append(c);this.context.append(g);this.proxy=new Porthole.WindowProxy(this.options.proxy,g.attr("id"));var e=this;"undefined"!==typeof window.postMessage&&window.addEventListener("message",function(a){switch(a.data.name){case "chromeMsgResp":e.proxy.post({event:a.data});break;case "chromePluginReady":e.pluginReady=!0}});this.proxy.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1)switch(a.name){case "chromeMsg":"undefined"!==typeof window.postMessage&&
window.postMessage(a,"*");break;case "init":c.remove();g.height(a.height).attr("height",a.height+"px");break;case "complete":e.options.complete.call(e,a);break;case "serverReady":e.pluginReady&&e.proxy.post({event:{name:"chromePluginReady"}})}})};
