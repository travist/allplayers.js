(function(){var c=!1,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!c&&this.init&&this.init.apply(this,arguments)}var f=this.prototype;c=!0;var g=new this;c=!1;for(var e in a)g[e]="function"==typeof a[e]&&"function"==typeof f[e]&&b.test(a[e])?function(a,d){return function(){var b=this._super;this._super=f[a];var c=d.apply(this,arguments);this._super=b;return c}}(e,a[e]):a[e];d.prototype=g;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
getTargetWindow:function(){return b.WindowProxy.getTargetWindow(this.targetWindowName)},post:function(a,d){void 0===d&&(d="*");this.dispatchMessage({data:a,sourceOrigin:this.getOrigin(),targetOrigin:d,sourceWindowName:c.name,targetWindowName:this.getTargetWindowName()})},addEventListener:function(a){this.eventListeners.push(a);return a},removeEventListener:function(a){var d;try{d=this.eventListeners.indexOf(a),this.eventListeners.splice(d,1)}catch(b){this.eventListeners=[]}},dispatchEvent:function(a){var b;
...
allplayers.embed.prototype.init=function(){document.proxy=this};allplayers=allplayers||{embed:{}};jQuery.fn.allplayers_client||(jQuery.fn.allplayers_client=function(c){return jQuery(this).each(function(){new allplayers.embed.client(c,jQuery(this))})});
allplayers.embed.client=function(c,b){this.context=b;allplayers.embed.call(this,c,{spinner:"https://www.allplayers.com/sites/all/themes/allplayers960/images/loading.gif",loading:"loading...",base:"https://platform.allplayers.com",type:"registration",group:"api",query:{},src:"",complete:function(){}})};allplayers.embed.client.prototype=new allplayers.embed;allplayers.embed.client.prototype.constructor=allplayers.embed.client;
...
"/register";break;case "forms":a+="/forms"}this.options.query.embedtype=this.options.type;a:{for(var f in this.options.query){d=!1;break a}d=!0}if(!d){var a=a+"?",g;for(g in this.options.query)a+=g+"="+encodeURIComponent(this.options.query[g]),a+="&";a=a.replace(/\&$/,"")}}var a=a+(-1===a.search(/\?/)?"?":"&"),a=a+("embedsource="+encodeURIComponent(window.location.href)),a=a+("#"+b),e=jQuery(document.createElement("iframe")).attr({id:b,name:b,scrolling:"no",seamless:"seamless",width:"100%",height:"0px",
src:a}).css({border:"none",overflowY:"hidden"});this.context.append(c);this.context.append(e);this.proxy=new Porthole.WindowProxy(this.options.proxy,e.attr("id"));var h=this;"undefined"!==typeof window.postMessage&&window.addEventListener("message",function(a){switch(a.data.name){case "chromeMsgResp":h.proxy.post({event:a.data});break;case "chromePluginReady":h.pluginReady=!0}});this.proxy.addEventListener(function(a){if(a=a.data.hasOwnProperty("event")?a.data.event:!1)switch(a.name){case "chromeMsg":"undefined"!==
typeof window.postMessage&&window.postMessage(a,"*");break;case "init":c.remove();e.height(a.height).attr("height",a.height+"px");break;case "complete":h.options.complete.call(h,a);break;case "serverReady":h.pluginReady&&h.proxy.post({event:{name:"chromePluginReady"}})}})};
