(function(){var c=!1,b=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;this.Class=function(){};Class.extend=function(a){function d(){!c&&this.init&&this.init.apply(this,arguments)}var g=this.prototype;c=!0;var f=new this;c=!1;for(var e in a)f[e]="function"==typeof a[e]&&"function"==typeof g[e]&&b.test(a[e])?function(a,d){return function(){var b=this._super;this._super=g[a];var c=d.apply(this,arguments);this._super=b;return c}}(e,a[e]):a[e];d.prototype=f;d.prototype.constructor=d;d.extend=arguments.callee;
return d}})();
...
allplayers.embed.prototype.init=function(){};allplayers=allplayers||{embed:{}};allplayers.embed.server=function(c){allplayers.embed.call(this,c,{getHeight:function(){return 0},isComplete:function(){return!1}})};allplayers.embed.server.prototype=new allplayers.embed;allplayers.embed.server.prototype.constructor=allplayers.embed.server;
allplayers.embed.server.prototype.init=function(){allplayers.embed.prototype.init.call(this);var c=!1,b=this,a=10,d=new Porthole.WindowProxy(this.options.proxy);d.addEventListener(function(a){a.data.hasOwnProperty("init")&&a.data.init&&(c=!0)});var g=function(){var f=b.options.getHeight();d.post({height:f,event:{name:"init",height:f,id:window.location.hash}});0>=a||c?b.options.isComplete()&&d.post({event:{name:"complete"}}):(a--,setTimeout(g,500))};g()};
