...
allplayers.embed.prototype.init=function(){};allplayers=allplayers||{embed:{}};allplayers.embed.server=function(c){allplayers.embed.call(this,c,{getHeight:function(){return 0},isComplete:function(){}})};allplayers.embed.server.prototype=new allplayers.embed;allplayers.embed.server.prototype.constructor=allplayers.embed.server;
allplayers.embed.server.prototype.init=function(){allplayers.embed.prototype.init.call(this);var c=!1,b=this,a=new Porthole.WindowProxy(this.options.proxy);a.addEventListener(function(a){a.data.hasOwnProperty("init")&&a.data.init&&(c=!0)});var d=function(){a.post({event:{name:"init",height:b.options.getHeight(),id:window.location.hash}});c?b.options.isComplete()&&a.post({event:{name:"complete"}}):setTimeout(d,500)};d()};
