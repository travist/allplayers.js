...
allplayers.embed.server.prototype.resize=function(){this.resized=!1;var c=this,b=c.options.getContainer();jQuery('a[href^="https://www."]',b).each(function(){var a=$(this).attr("href");$(this).attr({href:a.replace(/^https\:\/\/www\./,"https://platform.")})});var a=function(){var d=b.outerHeight(!0);c.proxy.post({height:d,event:{name:"init",height:d,id:window.location.hash}});c.resized?c.options.isComplete()&&c.proxy.post({event:{name:"complete"}}):setTimeout(a,500)};a()};
