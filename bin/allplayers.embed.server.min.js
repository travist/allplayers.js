...
allplayers.embed.server.prototype.resize=function(){jQuery('a[href^="https://www."]',container).each(function(){var a=$(this).attr("href");$(this).attr({href:a.replace(/https:\/\/www.(.*?).allplayers.com/,"https://platform.$1.allplayers.com")})});var c=this,b=function(){var a=c.container.outerHeight(!0);c.height!==a&&(c.height=a,c.proxy.post({height:c.height,event:{name:"init",height:c.height,id:window.location.hash}}));c.heightTimer&&clearTimeout(c.heightTimer);c.heightTimer=setTimeout(b,500)};b()};
