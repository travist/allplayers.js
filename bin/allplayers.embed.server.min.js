...
allplayers.embed.server.prototype.init=function(){allplayers.embed.prototype.init.call(this);this.resized=!1;var c=this;this.proxy=new Porthole.WindowProxy(this.options.proxy);this.proxy.addEventListener(function(a){a.data.hasOwnProperty("init")&&a.data.init&&(c.resized=!0)});var b=null;jQuery(document).bind("DOMSubtreeModified",function(){b&&clearTimeout(b);b=setTimeout(function(){c.resize()},500)});this.resize()};
allplayers.embed.server.prototype.resize=function(){this.resized=!1;var c=this,b=c.options.getContainer();jQuery('a[href^="https://www."]',b).each(function(){var a=$(this).attr("href");$(this).attr({href:a.replace(/https:\/\/www.(.*?).allplayers.com/,"https://platform.$1.allplayers.com")})});var a=function(){var d=b.outerHeight(!0);c.proxy.post({height:d,event:{name:"init",height:d,id:window.location.hash}});c.resized?c.options.isComplete()&&c.proxy.post({event:{name:"complete"}}):setTimeout(a,500)};
a()};
