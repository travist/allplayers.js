...
allplayers.embed.prototype.init=function(){};allplayers=allplayers||{embed:{}};allplayers.embed.server=function(c){allplayers.embed.call(this,c,{getContainer:function(){return jQuery()},isComplete:function(){return!1}})};allplayers.embed.server.prototype=new allplayers.embed;allplayers.embed.server.prototype.constructor=allplayers.embed.server;
allplayers.embed.server.prototype.init=function(){allplayers.embed.prototype.init.call(this);this.container=this.options.getContainer();this.height=0;this.heightTimer=null;var c=this;this.proxy=new Porthole.WindowProxy(this.options.proxy);var b=null;jQuery(document).bind("DOMSubtreeModified",function(){b&&clearTimeout(b);b=setTimeout(function(){c.height=0;c.resize()},500)});this.options.isComplete()&&this.proxy.post({event:{name:"complete"}});this.resize()};
